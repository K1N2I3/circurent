      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        <div className="mb-12">
          <h1 className="text-5xl md:text-6xl font-black text-white mb-4">
            ...
            <span className="gradient-text">{language === 'en' ? 'Orders' : 'Ordini'}</span>
          </h1>
          <p className="text-gray-400 text-xl">
            {language === 'en' 
              ? 'View all items you have rented'
              : 'Visualizza tutti gli articoli che hai noleggiato'
            }
          </p>
        </div>
          ...
          <div className="glass rounded-3xl p-12 text-center border border-white/10">
            <p className="text-gray-400 text-xl mb-6">
              {language === 'en' 
                ...
                : 'Non hai ancora noleggiato nessun articolo'
              }
            </p>
            <Link
              href="/"
